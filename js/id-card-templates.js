...
const ID_TEMPLATES = {
        ...
        <div class="id-card-wrapper temp-poppins-elite ${data.orientation}" style="width: 54mm; height: 86mm; background: white; border-radius: 3mm; box-shadow: 0 4px 10px rgba(0,0,0,0.1); overflow: hidden; position: relative; font-family: 'Poppins', sans-serif; box-sizing: border-box; border: 0.2mm solid #ddd;">
            <div class="header" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); padding: 3mm 4mm; text-align: center; color: white;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 2.5mm; margin-bottom: 1.5mm;">
                    <img src="${data.schoolLogo}" crossorigin="anonymous" style="height: 6mm; background: white; border-radius: 50%; padding: 1px;">
                ...
                <div style="font-size: 6.5pt; opacity: 0.9; font-weight: 300;">Identity Card ${data.session || '2025-26'}</div>
            </div>
            <div class="photo-area" style="display: flex; justify-content: center; margin-top: -8mm; position: relative; z-index: 2;">
                <div class="photo-frame" style="width: 25mm; height: 25mm; background-color: #f1f5f9; border: 1mm solid white; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.1); overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    ${data.photo ? `<img src="${data.photo}" crossorigin="anonymous" style="width: 100%; height: 100%; object-fit: cover;">` : `<div style="text-align: center;"><i class="fas fa-user" style="font-size: 2rem; color: #cbd5e1;"></i></div>`}
                </div>
            </div>
            <div class="content" style="padding: 2mm 5mm; text-align: center;">
                <div class="student-name" style="font-size: 13pt; font-weight: 800; color: #1e3c72; margin-bottom: 0.5mm; text-transform: uppercase; line-height: 1.1;">${data.name}</div>
                <div class="value" style="font-size: 7.5pt; color: #FF4B2B; font-weight: 700;">${data.class}${data.section ? '-' + data.section : ''} | Roll: #${data.rollNo} | ${data.studentId}</div>
                <div class="info-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 2mm; margin-top: 3mm; text-align: left;">
                    <div><strong style="display: block; font-size: 5pt; color: #1e3c72; text-transform: uppercase;">Father</strong><span style="font-size: 8pt; color: #333; font-weight: 700;">${data.fatherName}</span></div>
                    <div><strong style="display: block; font-size: 5pt; color: #1e3c72; text-transform: uppercase;">Mobile</strong><span style="font-size: 8pt; color: #333; font-weight: 700;">${data.mobile}</span></div>
                    <div><strong style="display: block; font-size: 5pt; color: #1e3c72; text-transform: uppercase;">DOB</strong><span style="font-size: 8pt; color: #333; font-weight: 700;">${data.dateOfBirth}</span></div>
                    <div><strong style="display: block; font-size: 5pt; color: #1e3c72; text-transform: uppercase;">Session</strong><span style="font-size: 8pt; color: #333; font-weight: 700;">${data.session || '2025-26'}</span></div>
                </div>
                <div style="margin-top: 2mm; text-align: left;">
                    <strong style="display: block; font-size: 5pt; color: #1e3c72; text-transform: uppercase;">Address</strong>
                    <span style="font-size: 6.5pt; color: #444; line-height: 1.1; display: block; max-height: 6mm; overflow: hidden;">${data.address}</span>
                </div>
            </div>
            <div class="footer" style="position: absolute; bottom: 0; width: 100%; background: #f8fafc; padding: 1.5mm 3mm; border-top: 0.2mm solid #eee; display: flex; justify-content: space-between; align-items: flex-end; box-sizing: border-box;">
                <div style="font-size: 5pt; color: #64748b; font-weight: 600; line-height: 1.2;"><i class="fas fa-phone"></i> ${data.schoolContact}</div>
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:9mm; height:9mm; border-radius:1mm;">
                <div class="signature-box" style="text-align: center;">
                    <img src="/images/principal-sign.png" crossorigin="anonymous" style="height: 6mm; mix-blend-mode: multiply;">
                    <div style="font-weight: 800; color: #1e3c72; text-transform: uppercase; font-size: 4.5pt; border-top: 0.2mm solid #333; padding-top: 0.3mm;">Principal</div>
                </div>
            </div>
        </div>
    `,
    ...
    format7: (data) => `
        <div class="id-card-wrapper temp-modern-tech-h ${data.orientation}" style="width: 86mm; height: 54mm; background: white; border-radius: 4mm; box-shadow: 0 10px 25px rgba(0,0,0,0.15); display: flex; overflow: hidden; font-family: 'Poppins', sans-serif; box-sizing: border-box; border: 0.2mm solid #ddd;">
            <div style="width: 30%; background: linear-gradient(135deg, #FF416C 0%, #FF4B2B 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; color: white; position: relative; padding: 2mm;">
                <div style="position: absolute; top: 3mm; font-size: 7pt; font-weight: 800; text-transform: uppercase; text-align: center; width: 90%; line-height: 1.1;">${data.schoolName}</div>
                <div style="width: 22mm; height: 22mm; background: rgba(255,255,255,0.25); border-radius: 2mm; margin-top: 4mm; display: flex; align-items: center; justify-content: center; border: 0.5mm solid rgba(255,255,255,0.4); overflow: hidden;">
                    ${data.photo ? `<img src="${data.photo}" crossorigin="anonymous" style="width: 100%; height: 100%; object-fit: cover;">` : `<div style="font-size:5pt; font-weight:700; opacity:0.6;">PHOTO</div>`}
                </div>
                <div style="margin-top: 2mm; background: rgba(0,0,0,0.15); padding: 0.3mm 2mm; border-radius: 1mm; font-size: 6.5pt; font-weight: 800;">ID: ${data.studentId}</div>
            </div>
            <div style="width: 70%; padding: 3mm 4mm; display: flex; flex-direction: column; justify-content: space-between; box-sizing: border-box;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        <h2 style="font-size: 14pt; font-weight: 800; color: #2d3436; margin: 0; line-height: 1; text-transform: uppercase;">${data.name}</h2>
                        <div style="font-size: 8pt; color: #FF4B2B; font-weight: 700; margin-top: 1mm;">${data.class}${data.section ? '-' + data.section : ''} | Roll #${data.rollNo}</div>
                    </div>
                    <img src="${data.schoolLogo}" crossorigin="anonymous" style="height: 7mm;">
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5mm; margin-top: 1.5mm;">
                    <div style="background: #f8f9fa; padding: 1mm 2mm; border-radius: 1mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #888; text-transform: uppercase; display: block;">Father</span>
                        <span style="font-size: 7.5pt; color: #2d3436; font-weight: 800;">${data.fatherName}</span>
                    </div>
                    <div style="background: #f8f9fa; padding: 1mm 2mm; border-radius: 1mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #888; text-transform: uppercase; display: block;">DOB</span>
                        <span style="font-size: 7.5pt; color: #2d3436; font-weight: 800;">${data.dateOfBirth}</span>
                    </div>
                    <div style="background: #f8f9fa; padding: 1mm 2mm; border-radius: 1mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #888; text-transform: uppercase; display: block;">Contact</span>
                        <span style="font-size: 7.5pt; color: #2d3436; font-weight: 800;">${data.mobile}</span>
                    </div>
                    <div style="background: #f8f9fa; padding: 1mm 2mm; border-radius: 1mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #888; text-transform: uppercase; display: block;">Session</span>
                        <span style="font-size: 7.5pt; color: #2d3436; font-weight: 800;">${data.session || '2025-26'}</span>
                    </div>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: flex-end; border-top: 0.2mm solid #eee; padding-top: 1.5mm; margin-top: 1mm;">
                    <div style="font-size: 5.5pt; color: #636e72;"><strong>PH:</strong> ${data.schoolContact}</div>
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:8mm; height:8mm; border-radius:1mm;">
                    <div style="text-align: right;">
                        <img src="/images/principal-sign.png" crossorigin="anonymous" style="height: 6mm; mix-blend-mode: multiply;">
                        <span style="font-size: 5pt; font-weight: 800; color:#2d3436; text-transform:uppercase; border-top:0.2mm solid #2d3436; display:block; padding-top:0.3mm;">Principal</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    format8: (data) => `
        <div class="id-card-wrapper temp-modern-tech-v2 ${data.orientation}" style="width: 86mm; height: 54mm; background: white; border-radius: 4mm; box-shadow: 0 15px 35px rgba(0,0,0,0.2); display: flex; overflow: hidden; font-family: 'Poppins', sans-serif; box-sizing: border-box; border: 0.2mm solid #ddd;">
            <div style="width: 34%; background: linear-gradient(145deg, #FF416C 0%, #FF4B2B 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; color: white; position: relative; padding: 3mm;">
                <div style="position: absolute; top: 3mm; left: 0; right: 0; font-size: 7.5pt; font-weight: 800; text-transform: uppercase; text-align: center; line-height: 1.1;">${data.schoolName}</div>
                <div style="width: 24mm; height: 24mm; background: rgba(255,255,255,0.2); border-radius: 3mm; margin-top: 5mm; display: flex; align-items: center; justify-content: center; border: 0.6mm solid rgba(255,255,255,0.35); overflow: hidden;">
                    ${data.photo ? `<img src="${data.photo}" crossorigin="anonymous" style="width: 100%; height: 100%; object-fit: cover;">` : `<div style="font-size:6pt; opacity:0.5;">PHOTO</div>`}
                </div>
                <div style="margin-top: 3mm; display: flex; flex-direction: column; align-items: center;">
                    <div style="background: rgba(255,255,255,0.25); padding: 0.2mm 2.5mm; border-radius: 1mm; font-size: 7pt; font-weight: 800;">${data.studentId}</div>
                    <span style="font-size: 4.5pt; opacity: 0.8; margin-top: 0.5mm; font-weight: 600; text-transform: uppercase;">Identity No</span>
                </div>
            </div>
            <div style="width: 66%; padding: 3mm 5mm; display: flex; flex-direction: column; justify-content: space-between; box-sizing: border-box;">
                <div>
                    <h2 style="font-size: 15pt; font-weight: 800; color: #2d3436; margin: 0; line-height: 1; text-transform: uppercase;">${data.name}</h2>
                    <div style="font-size: 8pt; color: #FF4B2B; font-weight: 700; display: flex; align-items: center; gap: 1.5mm; margin-top: 1mm;">
                        <span style="width: 12px; height: 0.6mm; background: #FF4B2B; border-radius: 0.5mm;"></span>
                        ${data.class}${data.section ? '-' + data.section : ''} | ROLL ${data.rollNo}
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5mm; margin-top: 1.5mm;">
                    <div style="background: #f1f3f5; padding: 1mm 2mm; border-radius: 1.5mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #adb5bd; text-transform: uppercase; font-weight: 800;">Father</span>
                        <span style="font-size: 8pt; color: #2d3436; font-weight: 800; line-height: 1; display:block;">${data.fatherName}</span>
                    </div>
                    <div style="background: #f1f3f5; padding: 1mm 2mm; border-radius: 1.5mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #adb5bd; text-transform: uppercase; font-weight: 800;">DOB</span>
                        <span style="font-size: 8pt; color: #2d3436; font-weight: 800; line-height: 1; display:block;">${data.dateOfBirth}</span>
                    </div>
                    <div style="background: #f1f3f5; padding: 1mm 2mm; border-radius: 1.5mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #adb5bd; text-transform: uppercase; font-weight: 800;">Mobile</span>
                        <span style="font-size: 8pt; color: #2d3436; font-weight: 800; line-height: 1; display:block;">${data.mobile}</span>
                    </div>
                    <div style="background: #f1f3f5; padding: 1mm 2mm; border-radius: 1.5mm; border-left: 0.8mm solid #FF4B2B;">
                        <span style="font-size: 4.5pt; color: #adb5bd; text-transform: uppercase; font-weight: 800;">Session</span>
                        <span style="font-size: 8pt; color: #2d3436; font-weight: 800; line-height: 1; display:block;">${data.session || '2025-26'}</span>
                    </div>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: flex-end; border-top: 0.3mm dashed #dee2e6; padding-top: 1.5mm; margin-top: 1mm;">
                    <div style="font-size: 5.5pt; color: #495057; line-height: 1.1;"><strong style="color: #2d3436;">PH:</strong> ${data.schoolContact}</div>
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:8mm; height:8mm; border-radius:1mm;">
                    <div style="text-align: center;">
                        <img src="/images/principal-sign.png" crossorigin="anonymous" style="height: 6mm; mix-blend-mode: multiply;">
                        <span style="font-size: 5pt; color: #2d3436; text-transform: uppercase; font-weight: 800; border-top:0.2mm solid #2d3436; display:block; padding-top:0.3mm;">Principal</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="id-card-wrapper temp-gradient-elite ${data.orientation}" style="width:54mm;height:86mm;background:linear-gradient(160deg,#1e3c72 0%,#2a5298 55%,#1a237e 100%);border-radius:3mm;overflow:hidden;position:relative;font-family:'Poppins',sans-serif;box-sizing:border-box;">
            ...
            <div style="padding:3mm 3mm 1.5mm;display:flex;align-items:center;justify-content:center;gap:2mm;position:relative;z-index:2;">
                ...
                <div style="color:#fff;text-align:left;">
                    ...
                    <div style="font-size:4.5pt;opacity:0.8;font-weight:500;letter-spacing:1px;text-transform:uppercase;">STUDENT IDENTITY CARD</div>
                </div>
            </div>
            ...
            <div style="padding:2.5mm 4.5mm;position:relative;z-index:2;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:2mm;">
                    ...
                    <div style="background:rgba(255,255,255,0.1);border-radius:1.5mm;padding:1.5mm 2mm;">
                        ...
                        <div style="font-size:8pt;font-weight:900;">${data.dateOfBirth}</div>
                    </div>
                </div>
            </div>
            ...
            <div style="position:absolute;bottom:0;width:100%;background:rgba(0,0,0,0.25);backdrop-filter:blur(4px);padding:1.5mm 4mm;box-sizing:border-box;display:flex;justify-content:space-between;align-items:center;">
                ...
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:9mm;height:9mm;border-radius:1mm;opacity:0.8;">
                <div style="text-align:center;">
                    <img src="/images/principal-sign.png" crossorigin="anonymous" style="height:6mm;filter:brightness(0) invert(1);opacity:0.7;mix-blend-mode:screen;">
        ...
        <div class="id-card-wrapper temp-stark-modern ${data.orientation}" style="width:86mm;height:54mm;background:#fff;border-radius:2mm;overflow:hidden;display:flex;font-family:'Inter',sans-serif;box-sizing:border-box;border:0.3mm solid #e2e8f0;box-shadow:0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="flex:1;padding:3.5mm 4mm;display:flex;flex-direction:column;justify-content:space-between;box-sizing:border-box;">
                ...
                <div style="display:flex;justify-content:space-between;align-items:flex-end;border-top:0.4mm solid #e2e8f0;padding-top:1.5mm;">
                    <div style="font-size:5pt;color:#64748b;">📞 ${data.schoolContact}</div>
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:8mm;height:8mm;border-radius:1mm;">
                    <div style="text-align:center;">
                        <img src="/images/principal-sign.png" crossorigin="anonymous" style="height:6mm;mix-blend-mode:multiply;">
    ...
    format11: (data) => `
        <div class="id-card-wrapper temp-royal-maroon ${data.orientation}" style="width:54mm;height:86mm;background:#fff;border-radius:2mm;overflow:hidden;position:relative;font-family:'Times New Roman',Georgia,serif;box-sizing:border-box;border:1mm solid #7b0000;">
            ...
            <div style="background:linear-gradient(135deg,#7b0000 0%,#9b1111 60%,#7b0000 100%);padding:3mm 2mm;text-align:center;position:relative;z-index:2;">
                ...
                <div style="color:rgba(255,255,255,0.75);font-size:5pt;font-style:italic;margin-top:0.5mm;">IDENTITY CARD</div>
                <!-- Gold divider -->
            ...
            <!-- Footer -->
            <div style="position:absolute;bottom:0;width:100%;background:linear-gradient(135deg,#7b0000,#9b1111);padding:1.5mm 3mm;box-sizing:border-box;display:flex;justify-content:space-between;align-items:center;">
                <div style="color:rgba(255,255,255,0.8);font-size:4pt;font-style:italic;">If found, please return to school</div>
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:8mm;height:8mm;border-radius:1mm;opacity:0.8;">
                <div style="text-align:center;">
                    <img src="/images/principal-sign.png" crossorigin="anonymous" style="height:5mm;filter:brightness(0) invert(1);opacity:0.7;">
                    <div style="color:#d4a017;font-size:3.5pt;font-weight:700;border-top:0.2mm solid #d4a017;text-transform:uppercase;margin-top:0.3mm;">Principal</div>
                </div>
            </div>
        </div>
    `,
            ...
            <div style="flex:1;display:flex;padding:2.5mm;gap:3mm;box-sizing:border-box;">
                ...
                <div style="flex:1;display:flex;flex-direction:column;justify-content:space-between;">
                    ...
                    <table style="width:100%;font-size:7pt;border-collapse:collapse;margin-top:1mm;">
                        ...
                        <tr><td style="color:#64748b;font-size:5pt;font-weight:700;text-transform:uppercase;">DOB</td><td style="font-weight:800;color:#1e293b;">${data.dateOfBirth}</td></tr>
                    </table>

                    <div style="font-size:5pt;color:#94a3b8;">📞 ${data.schoolContact}</div>
                </div>
            </div>
    ...
    format13: (data) => `
        <div class="id-card-wrapper temp-deep-space ${data.orientation}" style="width:54mm;height:86mm;background:linear-gradient(145deg,#0a0a1a 0%,#0f172a 60%,#0a0a1a 100%);border-radius:3mm;overflow:hidden;position:relative;font-family:'Inter',sans-serif;box-sizing:border-box;border:0.5mm solid #1e293b;">
            ...
            <div style="position:absolute;bottom:0;width:100%;padding:1.5mm 4mm;box-sizing:border-box;display:flex;justify-content:space-between;align-items:center;background:rgba(0,0,0,0.3);border-top:0.3mm solid rgba(255,255,255,0.06);">
                ...
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:9mm;height:9mm;border-radius:1mm;">
                <div style="text-align:center;">
                    <img src="/images/principal-sign.png" crossorigin="anonymous" style="height:5.5mm;filter:brightness(0) invert(1);opacity:0.5;">
    ...
    // Format 14: NAVAL PRESTIGE — Navy Blue + Gold, CR80 Vertical
    format14: (data) => `
        <div class="id-card-wrapper temp-naval-prestige ${data.orientation}" style="width:54mm;height:86mm;background:linear-gradient(160deg,#0d1b2a 0%,#1b2838 50%,#0d1b2a 100%);border-radius:3mm;overflow:hidden;position:relative;font-family:'Inter',sans-serif;box-sizing:border-box;border:0.5mm solid #d4a843;">
            <div style="position:absolute;inset:0;background:url('${data.schoolLogo}') center/contain no-repeat;opacity:0.04;z-index:0;"></div>
            <div style="position:absolute;top:-15mm;right:-15mm;width:45mm;height:45mm;border-radius:50%;border:0.3mm solid rgba(212,168,67,0.1);z-index:0;"></div>
            <div style="position:absolute;bottom:-10mm;left:-10mm;width:35mm;height:35mm;border-radius:50%;border:0.3mm solid rgba(212,168,67,0.08);z-index:0;"></div>
            <div style="padding:2.5mm 3mm 1.5mm;display:flex;align-items:center;justify-content:center;gap:2mm;position:relative;z-index:2;">
                <img src="${data.schoolLogo}" crossorigin="anonymous" style="height:9mm;filter:drop-shadow(0 0 5px rgba(212,168,67,0.4));background:rgba(255,255,255,0.08);border-radius:50%;padding:1px;">
                <div style="color:#d4a843;text-align:left;">
                    <div style="font-weight:900;font-size:9pt;line-height:1;text-transform:uppercase;letter-spacing:0.5px;">${data.schoolName}</div>
                    <div style="font-size:4.5pt;color:rgba(212,168,67,0.7);font-weight:600;text-transform:uppercase;letter-spacing:1px;">STUDENT IDENTITY CARD</div>
                </div>
            </div>
            <div style="height:0.5mm;background:linear-gradient(90deg,transparent,#d4a843,transparent);margin:0 3mm;position:relative;z-index:2;"></div>
            <div style="text-align:center;margin-top:2.5mm;position:relative;z-index:2;">
                <div style="width:26mm;height:26mm;border-radius:50%;margin:0 auto;padding:0.8mm;background:linear-gradient(135deg,#d4a843,#fff,#d4a843);box-shadow:0 0 14px rgba(212,168,67,0.4);">
                    <div style="width:100%;height:100%;border-radius:50%;overflow:hidden;background:#0d1b2a;">
                        ${data.photo ? `<img src="${data.photo}" crossorigin="anonymous" style="width:100%;height:100%;object-fit:cover;object-position:center top;">` : `<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;"><img src="${data.schoolLogo}" crossorigin="anonymous" style="width:50%;opacity:0.2;filter:brightness(0) invert(1);"></div>`}
                    </div>
                </div>
                <div style="display:inline-block;background:rgba(212,168,67,0.15);border:0.3mm solid #d4a843;color:#d4a843;font-size:6.5pt;font-weight:800;padding:0.3mm 2.5mm;border-radius:50px;margin-top:1mm;letter-spacing:0.5px;">ID: ${data.studentId}</div>
            </div>
            <div style="padding:2mm 4mm;position:relative;z-index:2;">
                <div style="color:#fff;text-align:center;font-weight:900;font-size:12pt;text-transform:uppercase;line-height:1;letter-spacing:0.3px;">${data.name}</div>
                <div style="text-align:center;margin:0.8mm 0 2mm;">
                    <span style="color:#d4a843;font-size:7pt;font-weight:700;">CLASS ${data.class}${data.section ? '-' + data.section : ''}</span>
                    <span style="color:rgba(255,255,255,0.4);margin:0 1.5mm;">|</span>
                    <span style="color:#e2e8f0;font-size:7pt;font-weight:700;">ROLL #${data.rollNo}</span>
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5mm;">
                    <div style="background:rgba(255,255,255,0.06);border:0.2mm solid rgba(255,255,255,0.1);border-radius:1.5mm;padding:1.5mm 2mm;">
                        <div style="color:rgba(212,168,67,0.8);font-size:4.5pt;font-weight:700;text-transform:uppercase;">Father</div>
                        <div style="color:#e2e8f0;font-size:7pt;font-weight:700;line-height:1.1;">${data.fatherName}</div>
                    </div>
                    <div style="background:rgba(255,255,255,0.06);border:0.2mm solid rgba(255,255,255,0.1);border-radius:1.5mm;padding:1.5mm 2mm;">
                        <div style="color:rgba(212,168,67,0.8);font-size:4.5pt;font-weight:700;text-transform:uppercase;">Mobile</div>
                        <div style="color:#e2e8f0;font-size:7pt;font-weight:700;line-height:1.1;">${data.mobile}</div>
                    </div>
                    <div style="background:rgba(255,255,255,0.06);border:0.2mm solid rgba(255,255,255,0.1);border-radius:1.5mm;padding:1.5mm 2mm;">
                        <div style="color:rgba(212,168,67,0.8);font-size:4.5pt;font-weight:700;text-transform:uppercase;">DOB</div>
                        <div style="color:#e2e8f0;font-size:7pt;font-weight:700;line-height:1.1;">${data.dateOfBirth}</div>
                    </div>
                    <div style="background:rgba(255,255,255,0.06);border:0.2mm solid rgba(255,255,255,0.1);border-radius:1.5mm;padding:1.5mm 2mm;">
                        <div style="color:rgba(212,168,67,0.8);font-size:4.5pt;font-weight:700;text-transform:uppercase;">Session</div>
                        <div style="color:#e2e8f0;font-size:7pt;font-weight:700;line-height:1.1;">${data.session || '2025-26'}</div>
                    </div>
                </div>
            </div>
            <div style="position:absolute;bottom:0;width:100%;padding:1.5mm 3mm;box-sizing:border-box;display:flex;justify-content:space-between;align-items:center;background:rgba(0,0,0,0.35);border-top:0.3mm solid rgba(212,168,67,0.2);z-index:2;">
                <div style="font-size:4.5pt;color:rgba(255,255,255,0.5);line-height:1.2;">📞 ${data.schoolContact}<br>If found, please return</div>
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:9mm;height:9mm;border-radius:1mm;opacity:0.8;">
                <div style="text-align:center;">
                    <img src="/images/principal-sign.png" crossorigin="anonymous" style="height:5mm;filter:brightness(0) invert(1);opacity:0.5;">
                    <div style="color:#d4a843;font-size:3.5pt;font-weight:800;border-top:0.2mm solid #d4a843;text-transform:uppercase;margin-top:0.3mm;">Principal</div>
                </div>
            </div>
        </div>
    `,

    // Format 15: MONOCHROME ELITE — Charcoal + White, CR80 Horizontal
    format15: (data) => `
        <div class="id-card-wrapper temp-mono-elite ${data.orientation}" style="width:86mm;height:54mm;background:#fff;border-radius:3mm;overflow:hidden;display:flex;font-family:'Inter',sans-serif;box-sizing:border-box;border:0.3mm solid #d1d5db;box-shadow:0 4px 16px rgba(0,0,0,0.1);">
            <div style="width:32%;background:linear-gradient(160deg,#1f2937 0%,#374151 50%,#1f2937 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;color:white;position:relative;padding:3mm;">
                <div style="position:absolute;inset:0;background:repeating-linear-gradient(45deg,transparent,transparent 2mm,rgba(255,255,255,0.02) 2mm,rgba(255,255,255,0.02) 4mm);z-index:0;"></div>
                <div style="position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;">
                    <img src="${data.schoolLogo}" crossorigin="anonymous" style="height:7mm;margin-bottom:1.5mm;filter:drop-shadow(0 0 4px rgba(255,255,255,0.2));">
                    <div style="font-size:5.5pt;font-weight:900;text-transform:uppercase;text-align:center;line-height:1.1;color:#d1d5db;margin-bottom:2mm;">${data.schoolName}</div>
                    <div style="width:22mm;height:26mm;border:0.5mm solid #4b5563;border-radius:2mm;overflow:hidden;background:#374151;">
                        ${data.photo ? `<img src="${data.photo}" crossorigin="anonymous" style="width:100%;height:100%;object-fit:cover;object-position:center top;">` : `<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;color:#6b7280;font-size:6pt;">PHOTO</div>`}
                    </div>
                    <div style="background:rgba(255,255,255,0.1);border:0.3mm solid #6b7280;padding:0.3mm 2mm;border-radius:1mm;font-size:6pt;font-weight:800;margin-top:1.5mm;color:#e5e7eb;">${data.studentId}</div>
                </div>
            </div>
            <div style="width:68%;padding:3mm 4mm;display:flex;flex-direction:column;justify-content:space-between;box-sizing:border-box;">
                <div>
                    <div style="display:flex;justify-content:space-between;align-items:flex-start;">
                        <div>
                            <h2 style="font-size:15pt;font-weight:900;color:#111827;margin:0;line-height:1;text-transform:uppercase;">${data.name}</h2>
                            <div style="display:flex;gap:2mm;margin-top:1mm;">
                                <span style="background:#1f2937;color:#fff;font-size:6pt;font-weight:800;padding:0.3mm 2mm;border-radius:50px;">${data.class}${data.section ? '-' + data.section : ''}</span>
                                <span style="color:#6b7280;font-size:6pt;font-weight:700;">Roll #${data.rollNo}</span>
                                <span style="color:#6b7280;font-size:6pt;font-weight:700;">|</span>
                                <span style="color:#6b7280;font-size:6pt;font-weight:700;">${data.session || '2025-26'}</span>
                            </div>
                        </div>
                    </div>
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5mm;margin-top:2.5mm;">
                        <div style="background:#f9fafb;padding:1mm 2mm;border-radius:1.5mm;border-left:0.8mm solid #1f2937;">
                            <span style="font-size:4pt;color:#9ca3af;text-transform:uppercase;font-weight:700;">Father</span>
                            <span style="font-size:7.5pt;color:#111827;font-weight:800;display:block;line-height:1;">${data.fatherName}</span>
                        </div>
                        <div style="background:#f9fafb;padding:1mm 2mm;border-radius:1.5mm;border-left:0.8mm solid #1f2937;">
                            <span style="font-size:4pt;color:#9ca3af;text-transform:uppercase;font-weight:700;">DOB</span>
                            <span style="font-size:7.5pt;color:#111827;font-weight:800;display:block;line-height:1;">${data.dateOfBirth}</span>
                        </div>
                        <div style="background:#f9fafb;padding:1mm 2mm;border-radius:1.5mm;border-left:0.8mm solid #1f2937;">
                            <span style="font-size:4pt;color:#9ca3af;text-transform:uppercase;font-weight:700;">Mobile</span>
                            <span style="font-size:7.5pt;color:#111827;font-weight:800;display:block;line-height:1;">${data.mobile}</span>
                        </div>
                        <div style="background:#f9fafb;padding:1mm 2mm;border-radius:1.5mm;border-left:0.8mm solid #1f2937;">
                            <span style="font-size:4pt;color:#9ca3af;text-transform:uppercase;font-weight:700;">Address</span>
                            <span style="font-size:6pt;color:#111827;font-weight:600;display:block;line-height:1.1;max-height:5mm;overflow:hidden;">${data.address}</span>
                        </div>
                    </div>
                </div>
                <div style="display:flex;justify-content:space-between;align-items:flex-end;border-top:0.3mm solid #e5e7eb;padding-top:1.5mm;margin-top:1.5mm;">
                    <div style="font-size:5pt;color:#6b7280;line-height:1.2;">📞 ${data.schoolContact}<br>If found, please return to school</div>
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent('https://snredu-erp.web.app/portal/student-login.html')}" crossorigin="anonymous" style="width:9mm;height:9mm;border-radius:1mm;">
                    <div style="text-align:center;">
                        <img src="/images/principal-sign.png" crossorigin="anonymous" style="height:6mm;mix-blend-mode:multiply;">
                        <div style="font-size:4pt;font-weight:800;color:#111827;border-top:0.3mm solid #111827;text-transform:uppercase;margin-top:0.3mm;">Principal</div>
                    </div>
                </div>
            </div>
        </div>
